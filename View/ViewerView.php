...
class ViewerView extends MainView {
    ...
    function displayPage() {
        ?>
        <!doctype html>
        <html lang="fr" dir="ltr" mozallowselectionprint moznomarginboxes>
        <head>
            <meta charset="utf-8">
    ...
    public function css(){
        ?>
        <link rel="stylesheet" href="/<?php echo BASE ?>data/js/pdf/viewer.css"/>
    <?php
    }
    ...
    public function javascript(){
        ?>
        <script>
            pdf = "/<?php echo BASE . $this->document->getContenu()?>";
        </script>
        <script type="text/javascript" src="/<?php echo BASE ?>data/js/pdf/compatibility.js"></script>
        <link rel="resource" type="application/l10n" href="/<?php echo BASE ?>data/js/pdf/locale/locale.properties"/>
        <script type="text/javascript" src="/<?php echo BASE ?>data/js/pdf/l10n.js"></script>
        <script type="text/javascript" src="/<?php echo BASE ?>data/js/pdf/pdf.js"></script>
        <script type="text/javascript" src="/<?php echo BASE ?>data/js/pdf/viewer.js"></script>
    <?php
    }
